        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Device>(entity =>
            {
                ...
                entity.OwnsOne(e => e.HardwareInfo, hardware =>
                {
                    ...
                    {
                        ram.HasKey(r => r.Id);
                        ram.Property(r => r.Id).ValueGeneratedOnAdd().UseIdentityColumn();
                    ...
                    {
                        disk.HasKey(d => d.Id);
                        disk.Property(d => d.Id).ValueGeneratedOnAdd().UseIdentityColumn();
                    ...
                    {
                        gpu.HasKey(g => g.Id);
                        gpu.Property(g => g.Id).ValueGeneratedOnAdd().UseIdentityColumn();
                    ...
                    hardware.OwnsMany(h => h.NetworkAdapters, adapter =>
                    {
                        ...
                        adapter.Property(a => a.Id).ValueGeneratedOnAdd().UseIdentityColumn();
