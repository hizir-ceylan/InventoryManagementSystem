...
powershell -Command "& { [Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/hizir-ceylan/InventoryManagementSystem/main/scripts/Install-InventorySystem.ps1' -OutFile '%TEMP%\InventoryInstall\Install-InventorySystem.ps1' -UseBasicParsing }"
